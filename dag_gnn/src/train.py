...
parser.add_argument('--graph_file', type=str, default='',
                    help='graph file name containing the graph.')
parser.add_argument('--data_dir', type=str, default= '',
                    help='data directory containing the data and graph.')
...
parser.add_argument('--use_A_positive_loss', type = int, default = 0,
...
try:
    for step_k in range(k_max_iter):
        ...
        while c_A < 1e+20:
            ...
            print("Best ELBO Epoch: {:04d}".format(best_ELBO_epoch))
            print("Best NLL Epoch: {:04d}".format(best_NLL_epoch))
            print("Best MSE Epoch: {:04d}".format(best_MSE_epoch))
